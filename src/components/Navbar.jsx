...
// import CartButton from "./CartButton"; // adjust the path if needed
...
//   return (
//     <div className="navbar bg-transparent px-2 md:px-8 lg:px-25 shadow-sm fixed">
...
//                 <div className="flex ">
//                   <div className="bg-amber-900 rounded-full w-4 h-4 text-white flex items-center justify-center">
//                     {user.photoURL ||
//                       user?.displayName
//                         ?.split(" ")
